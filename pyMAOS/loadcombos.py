...
# For ultimate (strength) design: 1.2 D + 1.6 L + 0.5 S
# For serviceability: 1.0D + 1.0 L
...
class LoadCombo:
    ...
    def __init__(
        ...
        combo_type : String, optional
            A string to indicate whether the combination is a design combination
    ...
    def __str__(self):
        ...
        """
        header=f"Combo: {self.name}\nType: {self.combo_type}\nPattern: {self.patterned}"

        key_loads = "Principle Loads: "
        ...
        return header+key_loads+combo_formula
