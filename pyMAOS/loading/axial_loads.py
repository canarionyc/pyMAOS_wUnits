...
class R2_Axial_Load(R2_Axial_Load_Base):
    @unit_manager.ureg.check(None,str(unit_manager.INTERNAL_FORCE_UNIT),str(unit_manager.INTERNAL_LENGTH_UNIT),None,None)
    ...
    def FEF(self):
        ...
        return pyMAOS.unit_manager.ureg.Quantity(result_array, pyMAOS.unit_manager.INTERNAL_FORCE_UNIT)
...
class R2_Axial_Linear_Load(R2_Axial_Load_Base):
    @unit_manager.ureg.check(None, str(unit_manager.INTERNAL_FORCE_UNIT),str(unit_manager.INTERNAL_FORCE_UNIT),str(unit_manager.INTERNAL_LENGTH_UNIT), str(unit_manager.INTERNAL_LENGTH_UNIT), None, None)
