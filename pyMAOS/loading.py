...
#                 func = ""
#                 has_term = False  # Track if we've added any term yet
#
#                 for i, coeff in enumerate(line[0]):
#                     if abs(coeff) < 1e-10:  # Skip effectively zero coefficients
#                         continue
#
...
#
#         Sz = [
#             [[self.c01 / self.EI, 0, self.Riy / (2 * self.EI)], [0, self.a]],
#             [
#                 [
#                     self.c02 / self.EI,
#                     -1 * self.M / self.EI,
...
#
#         # Constants of Integration
#         self.c01 = ((3 * M * a * a) - (6 * L * M * a) + (2 * L * L * M)) / (6 * L)
#
#         self.c02 = ((3 * M * a * a) + (2 * L * L * M)) / (6 * L)
#
#         self.c03 = 0
#
#         self.c04 = -1 / 2 * M * a * a
...
#
#         Mz = [
#             [[self.c01, self.Riy], [0, self.a]],
#             [[self.c02, self.Riy + self.p], [self.a, self.L]],
#         ]
#
#         Sz = [
#             [[self.c03, self.c01, self.Riy / 2], [0, self.a]],
#             [[self.c04, self.c02, (self.Riy + self.p) / 2], [self.a, self.L]],
#         ]
#
#         Dy = [
#             [[self.c05, self.c03, self.c01 / 2, self.Riy / 6], [0, self.a]],
#             [
#                 [self.c06, self.c04, self.c02 / 2, (self.Riy + self.p) / 6],
#                 [self.a, self.L],
#             ],
#         ]
#
...
#
#         Sz = [
#             [[self.c07, self.c04, 0.5 * self.c01], [0, self.a]],
#             [
#                 [
#                     self.c08,
#                     self.c05,
...
#
#         Dy = [
#             [[self.c10, self.c07, 0.5 * self.c04, self.c01 / 6], [0, self.a]],
#             [
#                 [
#                     self.c11,
#                     self.c08,
...
#
#         self.Wx = PiecewisePolynomial()  # Axial Load Function
#         self.Wy = PiecewisePolynomial(Wy)  # Vertical Load Function
#         self.Ax = PiecewisePolynomial()
#         self.Dx = PiecewisePolynomial()
#         self.Vy = PiecewisePolynomial(Vy)
#         self.Mz = PiecewisePolynomial(Mz)
...
#         c09 = self.c09
#
#         Miz = -1 * (c03 * L * L + 2 * c06 * L + 2 * c09 + 4 * c07) / L
#         Mjz = -1 * (2 * c03 * L * L + 4 * c06 * L + 4 * c09 + 2 * c07) / L
#         Riy = self.Riy + (Miz / L) + (Mjz / L)
#         Rjy = self.Rjy - (Miz / L) - (Mjz / L)
...
#
#         Dx = [
#             [[self.c01, -1 * self.Rix], [0, self.a]],
#             [[self.c02, -1 * self.Rix - self.p], [self.a, self.L]],
#         ]
#
...
#                 [self.a, self.b],
#             ],
#             [[self.c04, -1 * self.Rix - self.W], [self.b, self.L]],
#         ]
#
#         Dx[0][0] = [i / self.EA for i in Dx[0][0]]
#         Dx[1][0] = [i / self.EA for i in Dx[1][0]]
...
#         self.c02 = 0
#
#         self.c03 = (a * a * (a * w2 - 3 * b * w1 + 2 * a * w1)) / (6 * (b - a))
#
#         self.c04 = (
#             (2 * b * b - a * b - a * a) * w2 + (b * b + a * b - 2 * a * a) * w1
#         ) / 6
