...
# Members
RF1 = R2Frame(1,N1, N2, SteelMaterial, ColumnSection)
RF2 = R2Frame(2,N2, N3, SteelMaterial, BeamSection)
RF3 = R2Frame(3,N3, N4, SteelMaterial, ColumnSection)
RF4 = R2Truss(4,N2, N4, SteelMaterial, BraceSection)
RF5 = R2Truss(5,N1, N3, SteelMaterial, BraceSection)
...
print(K)
np.savetxt('K_ORIG.csv', K, delimiter=',', fmt='%f')
